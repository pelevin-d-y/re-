  ...
  const notificationsItems = [
    {
      ...
      user: state.data?.contacts ? state.data.contacts[0] : null,
    ...
    },
    {
      ...
      user: state.data?.contacts ? state.data.contacts[1] : null,
      old: 'Landon Tucker',
    ...
    },
    {
      ...
      user: state.data?.contacts ? state.data.contacts[2] : null,
